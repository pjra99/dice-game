      ...
      <div className="row game-play-section">
        ...
        <div className="col-md-4 dice">
          <div className="row nested-row-left-player-name">
            ...
            <div className="col-md-5 player-name-for-dice">
              {" "}
              <p className="player-1">
                <span className="player-names">{playerOne}'s</span>&nbsp;dice
              </p>{" "}
            </div>
          ...
          <div className="row nested-row-left-scores">
            ...
            <div className="col-md-7 score-details">
              Score:
              <br />
              Round Score: {roundScore1}{" "}
              <button
                className="hold-button"
                onMouseDown={() => handleHoldClick(1)}
              >
                Hold
              </button>{" "}
              <br />
        ...
        <div className="col-md-2 winning-score">
          {" "}
        ...
        <div className="col-md-4 dice">
          <div className="row nested-row-right-player-name">
            <div className="col-md-2"></div>
            <div className="col-md-4 player-name-for-dice">
              <p className="player-2">
                <span className="player-names player-2">{playerTwo}'s</span>
                &nbsp;dice
              </p>
            </div>
          ...
          <div className="row nested-row-right-scores">
            ...
            <div className="col-md-7 score-details">
              Score: <br />
              Round Score: {roundScore2}{" "}
              <button
                className="hold-button"
                onClick={() => handleHoldClick(2)}
              >
                Hold
              </button>{" "}
              <br />
